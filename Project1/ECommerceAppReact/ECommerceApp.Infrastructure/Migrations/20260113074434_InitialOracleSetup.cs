        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSeller = table.Column<bool>(type: "NUMBER(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    OrderDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    ShippedDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    DeliveredDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    BuyerId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
                    SellerId = table.Column<string>(type: "NVARCHAR2(450)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "General", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Application name", true, "SiteName", null, "ECommerce Store" },
                    { 2, "General", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Administrator email", true, "AdminEmail", null, "admin@ecommerce.com" },
                    { 3, "Payment", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Default currency", true, "Currency", null, "USD" },
                    { 4, "Payment", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tax rate (10%)", true, "TaxRate", null, "0.10" },
                    { 5, "Shipping", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Standard shipping fee", true, "ShippingFee", null, "5.00" },
                    { 6, "Shipping", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Free shipping minimum order", true, "FreeShippingThreshold", null, "50.00" },
                    { 7, "Cart", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Maximum items in cart", true, "MaxCartItems", null, "50" },
                    { 8, "Display", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Products displayed per page", true, "ProductsPerPage", null, "12" }
                });
